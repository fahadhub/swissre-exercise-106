Note: Checks and handlers can be added for these assumptions to make the code more robust, but in the interest of time and to keep the program simple as required by the problem statement, the assumptions mentioned below are made.
Assumptions:
...
2. Once jar gets created, run java -jar target/employee-analyzer.jar <path-to-csv-file>
